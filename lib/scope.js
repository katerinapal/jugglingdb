 ...
 */
ModelBinding.scope = function (name, params) {
        ...
        get: function get() {
            var f = function caller(condOrRefresh, cb) {
                ...
                if (cached && !condOrRefresh) {
                    ...
                    return _when2.default.resolve(cached);
                }
...
var exported_defineScope = defineScope;
exports.defineScope = exported_defineScope;
