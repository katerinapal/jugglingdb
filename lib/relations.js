...
_model2.default.relationNameFor = function relationNameFor(foreignKey) {
    var _this = this;
 ...
 */
_model2.default.hasMany = function hasMany(anotherClass, params) {
    var _this2 = this;
 ...
 */
_model2.default.belongsTo = function (anotherClass, params) {
    var _this3 = this;
    ...
    this.prototype[methodName] = function (p) {
        ...
        // acts as setter
        if (p instanceof _model2.default) {
 ...
 */
_model2.default.hasAndBelongsToMany = function hasAndBelongsToMany(anotherClass, params) {
    params = params || {};
