...
exports.AbstractClass = undefined;
...
var validationsjs_moduleDefault = _interopRequireWildcard(_validations);
...
var ValidationError = validationsjs_moduleDefault.ValidationError;
...
AbstractClass.update = function (id, data, cb) {
    ...
    if ((typeof id === "undefined" ? "undefined" : _typeof(id)) === 'object' && arguments.length === 2 && typeof data === 'function') {
        return _util2.default.deprecate(function () {
...
AbstractClass.bulkUpdate = function (params, cb) {
    ...
    (0, _assert2.default)(params.update, 'Required update');
    (0, _assert2.default)(params.where, 'Required where');
...
AbstractClass.prototype.inspect = function () {
    return _util2.default.inspect(this.__data, false, 4, true);
};
...
var exported_AbstractClass = AbstractClass;
 ...
 */
exports.AbstractClass = exported_AbstractClass;
