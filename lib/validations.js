 ...
 */
_model2.default.validatesPresenceOf = getConfigurator('presence');
 ...
 */
_model2.default.validatesLengthOf = getConfigurator('length');
 ...
 */
_model2.default.validatesNumericalityOf = getConfigurator('numericality');
 ...
 */
_model2.default.validatesInclusionOf = getConfigurator('inclusion');
 ...
 */
_model2.default.validatesExclusionOf = getConfigurator('exclusion');
 ...
 */
_model2.default.validatesFormatOf = getConfigurator('format');
 ...
 */
_model2.default.validate = getConfigurator('custom');
 ...
 * @see helper/validateCustom
 */
_model2.default.validateAsync = getConfigurator('custom', { async: true });
 ...
 */
_model2.default.validatesUniquenessOf = getConfigurator('uniqueness', { async: true });
 ...
 * ```
 */
_model2.default.prototype.isValid = function (callback, data) {
    var inst = this;
