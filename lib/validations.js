import { AbstractClass as Validatable } from "./model.js";
var ValidatableBinding = Validatable;
'use strict';
 ...
 */
ValidatableBinding.validatesPresenceOf = getConfigurator('presence');
 ...
 */
ValidatableBinding.validatesLengthOf = getConfigurator('length');
 ...
 */
ValidatableBinding.validatesNumericalityOf = getConfigurator('numericality');
 ...
 */
ValidatableBinding.validatesInclusionOf = getConfigurator('inclusion');
 ...
 */
ValidatableBinding.validatesExclusionOf = getConfigurator('exclusion');
 ...
 */
ValidatableBinding.validatesFormatOf = getConfigurator('format');
 ...
 */
ValidatableBinding.validate = getConfigurator('custom');
 ...
 * @see helper/validateCustom
 */
ValidatableBinding.validateAsync = getConfigurator('custom', { async: true });
 ...
 */
ValidatableBinding.validatesUniquenessOf = getConfigurator('uniqueness', { async: true });
 ...
 * ```
 */
ValidatableBinding.prototype.isValid = function(callback, data) {
    const inst = this;
...
var exported_ValidationError = ValidationError;
export { exported_ValidationError as ValidationError };
