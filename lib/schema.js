...
Schema.prototype.define = function defineClass(className, properties, settings) {
    ...
    var NewClass = function ModelConstructor(data, schema) {
        ...
        _model2.default.call(this, data);
    ...
    Object.keys(_model2.default).forEach(function (key) {
        NewClass[key] = _model2.default[key];
    });

    Object.keys(_model2.default.prototype).forEach(function (key) {
        NewClass.prototype[key] = _model2.default.prototype[key];
    });
