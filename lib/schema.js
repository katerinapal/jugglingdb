...
var existsSync = _fs2.default.existsSync || _path2.default.existsSync;
...
function Schema(name, settings) {
    ...
    schema.connect = function (cb) {
        ...
        return new _when2.default.Promise(function (resolve, reject) {
...
_util2.default.inherits(Schema, EventEmitter);
...
Schema.prototype.define = function defineClass(className, properties, settings) {
    ...
    var NewClass = function ModelConstructor(data, schema) {
        ...
        _model.AbstractClass.call(this, data);
    ...
    Object.keys(_model.AbstractClass).forEach(function (key) {
        NewClass[key] = _model.AbstractClass[key];
    });

    Object.keys(_model.AbstractClass.prototype).forEach(function (key) {
        NewClass.prototype[key] = _model.AbstractClass.prototype[key];
    });
...
Schema.prototype.copyModel = function copyModel(Master) {
    ...
    _util2.default.inherits(Slave, Master);
 ...
 * ```
 */
exports.Schema = exported_Schema;
